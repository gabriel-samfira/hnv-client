...
class TestField(unittest.TestCase):
    ...
    def test_properties(self):
        field = model.Field(name=mock.sentinel.name, key=mock.sentinel.name,
                            is_required=False, default=mock.sentinel.default)
...
class TestModel(unittest.TestCase):
    ...
    def test_dump(self):
        ...
        self.assertEqual(test.dump(), {"key1": 1, "key2": 2})
